        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((p) => (
            <div key={p.id}
              ...
              className="group flex flex-col rounded-2xl overflow-hidden bg-white/70 backdrop-blur-xl border border-[#1C1714]/10 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(255,106,28,0.15)] hover:border-orange-500/40 cursor-pointer"
            >
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                <div className="flex gap-4" onClick={(e) => e.stopPropagation()}>
                  <a href={p.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs text-[#1C1714]/45 hover:text-orange-500 transition-colors">
